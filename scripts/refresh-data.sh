...
run "wfp-food-prices" node scripts/sources/wfp-food-prices-pse.js
run "ioda-connectivity" node scripts/sources/ioda-connectivity-pse.js
run "palopenmaps"     node scripts/sources/palopenmaps-places.js
run "unrwa-aid-trucks" node scripts/sources/unrwa-aid-trucks.js
run "who-ssa"         node scripts/sources/who-ssa-attacks.js
run "unosat-damage"   node scripts/sources/unosat-gaza-damage.js
run "reliefweb"       node scripts/sources/reliefweb-pse.js
run "ocha-casualties" node scripts/sources/ocha-casualties.js
run "ocha-demolitions" node scripts/sources/ocha-demolitions.js
run "peacenow-settlers" node scripts/sources/peacenow-settlements.js
run "hamoked-detention" node scripts/sources/hamoked-detention.js
run "pcbs-indicators"  node scripts/sources/pcbs-indicators.js
